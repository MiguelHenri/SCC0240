...
('Sobrado Aconchegante', 'Rua do Bosque, 456', 4, 4, 3, 2, 300.00, 8, 2, 10, 70.00, '14:00', '12:00', 'Não é permitido fumar dentro da casa.', 'Jardim, Churrasqueira, Sala de jogos', false),
...
('Cabana à Beira do Rio', 'Estrada do Rio, 777', 1, 10, 1, 1, 180.00, 2, 1, 7, 40.00, '12:00', '10:00', 'Check-in automático.', 'Rio particular, Deck privativo, Churrasqueira', false),
('Sobrado Familiar', 'Rua dos Sonhos, 789', 4, 1, 3, 2, 320.00, 8, 2, 14, 80.00, '15:00', '11:00', 'Não é permitido fumar dentro da casa.', 'Pátio com jardim, Churrasqueira, Sala de jogos', false),
('Casa de Praia Relaxante', 'Av. do Sol, 456', 5, 1, 4, 3, 420.00, 10, 3, 14, 90.00, '16:00', '12:00', 'Check-in após as 16:00.', 'Piscina, Chuveiro externo, Varanda com vista para o mar', false),
('Loft Urbano', 'Rua das Ruas, 1010', 1, 1, 2, 1, 220.00, 2, 1, 7, 50.00, '14:00', '12:00', 'Proibido festas ou eventos.', 'Wi-Fi, Ar condicionado, Cozinha americana', false),
('Chalé da Serra', 'Travessa da Serra, 222', 1, 2, 1, 1, 260.00, 2, 1, 7, 60.00, '14:00', '12:00', 'Apenas para casais.', 'Lareira, Banheira de hidromassagem, Vista panorâmica', false),
('Casa de Campo Acolhedora', 'Estrada da Tranquilidade, 999', 3, 2, 3, 2, 300.00, 6, 2, 10, 70.00, '14:00', '12:00', 'Não é permitido fumar dentro da casa.', 'Jardim, Churrasqueira, Cozinha completa', true),
...
('Cabana à Beira do Riacho', 'Estrada do Riacho, 777', 1, 2, 1, 1, 200.00, 2, 1, 7, 50.00, '12:00', '10:00', 'Check-in automático.', 'Riacho particular, Deck privativo, Churrasqueira', false),
('Sobrado Confortável', 'Rua dos Sonhos, 789', 4, 2, 3, 2, 340.00, 8, 2, 14, 90.00, '15:00', '11:00', 'Não é permitido fumar dentro da casa.', 'Pátio com jardim, Churrasqueira, Sala de jogos', false),
...
VALUES 
(8, 1, '2024-01-15', '2024-02-01', '2024-02-10', 4, 30.00, 1000.00, 1030.00, 'VERAO2024', 50.00, true),
(9, 2, '2024-01-20', '2024-02-05', '2024-02-15', 2, 20.00, 900.00, 920.00, 'DESCONTO10', 30.00, true),
(10, 3, '2024-02-01', '2024-02-15', '2024-02-20', 2, 15.00, 600.00, 615.00, NULL, 0.00, true),
(11, 4, '2024-02-05', '2024-02-20', '2024-02-28', 6, 35.00, 1500.00, 1535.00, 'INVERNO', 70.00, true),
(12, 5, '2024-02-10', '2024-03-01', '2024-03-10', 8, 50.00, 2500.00, 2550.00, 'PROMO50', 100.00, true),
(13, 6, '2024-02-15', '2024-03-05', '2024-03-10', 2, 10.00, 600.00, 610.00, NULL, 0.00, true),
(14, 1, '2024-03-01', '2024-03-15', '2024-03-25', 2, 15.00, 900.00, 915.00, 'AGOSTO', 40.00, true),
(15, 2, '2024-03-10', '2024-04-01', '2024-04-10', 4, 25.00, 1400.00, 1425.00, NULL, 0.00, true),
(16, 3, '2024-03-15', '2024-04-05', '2024-04-10', 2, 10.00, 500.00, 510.00, 'JUNHO2024', 20.00, true),
(17, 4, '2024-03-20', '2024-04-10', '2024-04-20', 2, 15.00, 900.00, 915.00, NULL, 0.00, true),
(18, 1, '2024-04-01', '2024-04-20', '2024-04-30', 6, 35.00, 1600.00, 1635.00, 'JULHO2024', 70.00, true),
(19, 2, '2024-04-05', '2024-04-25', '2024-05-05', 6, 30.00, 1700.00, 1730.00, NULL, 0.00, true),
(20, 3, '2024-04-10', '2024-05-01', '2024-05-10', 2, 20.00, 800.00, 820.00, 'PROMO20', 40.00, true),
(8, 4, '2024-04-15', '2024-05-05', '2024-05-15', 4, 25.00, 1300.00, 1325.00, NULL, 0.00, true),
(9, 1, '2024-04-20', '2024-05-10', '2024-05-20', 2, 15.00, 600.00, 615.00, 'DESCONTO15', 30.00, true),
(10, 2, '2024-04-25', '2024-05-15', '2024-05-25', 2, 20.00, 1000.00, 1020.00, NULL, 0.00, true),
(11, 10, '2024-05-01', '2024-05-20', '2024-05-30', 6, 35.00, 1500.00, 1535.00, 'INVERNO15', 50.00, true),
(12, 10, '2024-05-05', '2024-06-01', '2024-06-10', 8, 50.00, 2800.00, 2850.00, 'VERAO50', 100.00, true),
(13, 10, '2024-05-10', '2024-06-15', '2024-06-25', 4, 25.00, 1400.00, 1425.00, NULL, 0.00, true),
(14, 10, '2024-05-15', '2024-06-05', '2024-06-15', 2, 15.00, 800.00, 815.00, 'JUNHO20', 20.00, true);
